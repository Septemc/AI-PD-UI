...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='F:/桌面/AI-ParticipationDetection/【4.28.15】/datasets/big_pic', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
